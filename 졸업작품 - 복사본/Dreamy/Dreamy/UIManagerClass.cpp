...
void UIManagerClass::Initialize(int screenWidth, int screenHeight)
{
	...
	m_UI[0]->Initialize(screenWidth, screenHeight, L"../Dreamy/Data/UI1.png", screenWidth, screenHeight);
													 
	m_UI[1] = new ImageClass;						 
	m_UI[1]->Initialize(screenWidth, screenHeight, L"../Dreamy/Data/UI2.png", screenWidth, screenHeight);
													
	m_UI[2] = new ImageClass;						
	m_UI[2]->Initialize(screenWidth, screenHeight, L"../Dreamy/Data/UI3.png", screenWidth, screenHeight);
													 
	m_UI[3] = new ImageClass;						 
	m_UI[3]->Initialize(screenWidth, screenHeight, L"../Dreamy/Data/UI4.png", screenWidth, screenHeight);
													 
	m_UI[4] = new ImageClass;						 
	m_UI[4]->Initialize(screenWidth, screenHeight, L"../Dreamy/Data/UI5.png", screenWidth, screenHeight);
...
void UIManagerClass::renderUI(TextureShaderClass* Shader, D3DXMATRIX worldMatrix, D3DXMATRIX ImageViewMatrix, D3DXMATRIX orthoMatrix)
{
	...
	if (m_UI[3]->active == true && render[2] == true)
	{
		m_UI[2]->active = false;
		m_UI[3]->Render(0, 0);
...
{
	if (m_UI[0]->active == false && render[0]==false)
		m_UI[0]->active = true;

	else if (m_UI[0]->active == true && m_UI[1]->active == false && render[1] == false)
		m_UI[1]->active = true;

	else if (m_UI[1]->active == true && m_UI[2]->active == false && render[2] == false)
		m_UI[2]->active = true;

	else if (m_UI[2]->active == true && m_UI[3]->active == false && render[3] == false)
		m_UI[3]->active = true;
