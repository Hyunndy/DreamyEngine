...
ModelScene::~ModelScene()
{
	...
	for each(FBXAnimationModel* temp in models)
		SAFE_DELETE(temp);
...
void ModelScene::Update()
{
	...
	if (animationController != NULL)
	{
		...
		if (isAnimated == true)
		{
			...
			for each(FBXAnimationModel* model in models)
...
void ModelScene::ProcessMesh(FbxNode * node)
{
	...
	***************************************************************/
	...
	FBXAnimationModel* model = new FBXAnimationModel(String::StringToWString(node->GetName()), modelBuffer);
